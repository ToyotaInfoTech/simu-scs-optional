...
// The original code can be found at `veins/modules/mobility/traci/TraCIScnarioManager.h` of Veins-5.2. 
...
//class TraCICommandInterfaceScs;
 ...
 * TraCIScenarioNetManagerLaunchd module and sumo-launchd.py script instead.
 *
 ...
 *
 */
class VEINS_API TraCIScenarioNetManager : public cSimpleModule, public cISimulationLifecycleListener {
public:
    ...
    TraCIScenarioNetManager();
    ~TraCIScenarioNetManager() override;
    ...
    TraCICommandInterfaceScs* getCommandInterface() const
    {
...
protected:
    ...
    std::unique_ptr<TraCICommandInterfaceScs> commandIfc;
...
class VEINS_API TraCIScenarioNetManagerAccess {
public:
    TraCIScenarioNetManager* get()
    {
        return FindModule<TraCIScenarioNetManager*>::findGlobalModule();
    };
};
