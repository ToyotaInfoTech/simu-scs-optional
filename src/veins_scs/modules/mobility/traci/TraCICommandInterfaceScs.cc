...
// The original code can be found at `veins/modules/mobility/traci/TraCICommandInterface.cc` of Veins-5.2. 

#include <stdlib.h>

#include "TraCICommandInterfaceScs.h"
...
const std::map<uint32_t, TraCICommandInterfaceScs::VersionConfig> TraCICommandInterfaceScs::versionConfigs = {
...
TraCICommandInterfaceScs::TraCICommandInterfaceScs(cComponent* owner, TraCIConnection& c, bool ignoreGuiCommands)
    : HasLogProxy(owner)
    , connection(c)
...
bool TraCICommandInterfaceScs::isIgnoringGuiCommands()
{
    return ignoreGuiCommands;
}

std::pair<uint32_t, std::string> TraCICommandInterfaceScs::getVersion()
{
...
void TraCICommandInterfaceScs::setApiVersion(uint32_t apiVersion)
{
    try {
...
std::pair<TraCICoord, TraCICoord> TraCICommandInterfaceScs::initNetworkBoundaries(int margin)
{
...
void TraCICommandInterfaceScs::Vehicle::setSpeedMode(int32_t bitset)
{
...
void TraCICommandInterfaceScs::Vehicle::setSpeed(double speed)
{
...
void TraCICommandInterfaceScs::Vehicle::setMaxSpeed(double speed)
{
...
TraCIColor TraCICommandInterfaceScs::Vehicle::getColor()
{
...
void TraCICommandInterfaceScs::Vehicle::setColor(const TraCIColor& color)
{
    TraCIBuffer p;
    p << static_cast<uint8_t>(VAR_COLOR);
    p << nodeId;
...
void TraCICommandInterfaceScs::Vehicle::slowDown(double speed, simtime_t time)
{
...
void TraCICommandInterfaceScs::Vehicle::newRoute(std::string roadId)
{
...
void TraCICommandInterfaceScs::Vehicle::setParking()
{
    throw cRuntimeError("TraCICommandInterfaceScs::Vehicle::setParking is non-functional as of SUMO 1.0.0");
}

std::list<std::string> TraCICommandInterfaceScs::getVehicleTypeIds()
{
    return genericGetStringList(CMD_GET_VEHICLETYPE_VARIABLE, "", ID_LIST, RESPONSE_GET_VEHICLETYPE_VARIABLE);
}

double TraCICommandInterfaceScs::getVehicleTypeMaxSpeed(std::string typeId)
{
    return genericGetDouble(CMD_GET_VEHICLETYPE_VARIABLE, typeId, VAR_MAXSPEED, RESPONSE_GET_VEHICLETYPE_VARIABLE);
}

void TraCICommandInterfaceScs::setVehicleTypeMaxSpeed(std::string typeId, double maxSpeed)
{
    genericSetDouble(CMD_SET_VEHICLETYPE_VARIABLE, typeId, VAR_MAXSPEED, maxSpeed);
}

std::list<std::string> TraCICommandInterfaceScs::getRouteIds()
{
    return genericGetStringList(CMD_GET_ROUTE_VARIABLE, "", ID_LIST, RESPONSE_GET_ROUTE_VARIABLE);
}

void TraCICommandInterfaceScs::addRoute(std::string routeId, const std::list<std::string>& edges)
{
    TraCIBuffer p;
...
bool TraCICommandInterfaceScs::Vehicle::isStopReached() const
{
    return getStopState() & 0x1;
}

void TraCICommandInterfaceScs::Vehicle::changeTarget(const std::string& newTarget) const
{
    TraCIBuffer p;
...
double TraCICommandInterfaceScs::getDistance(const Coord& p1, const Coord& p2, bool returnDrivingDistance)
{
...
void TraCICommandInterfaceScs::Vehicle::stopAt(std::string roadId, double pos, uint8_t laneid, double radius, simtime_t waittime)
{
...
std::pair<std::string, double> TraCICommandInterfaceScs::Vehicle::getLeader(const double distance)
{
...
std::vector<std::tuple<std::string, int, double, char>> TraCICommandInterfaceScs::Vehicle::getNextTls()
{
...
int32_t TraCICommandInterfaceScs::Trafficlight::getCurrentPhaseIndex() const
{
    return traci->genericGetInt(CMD_GET_TL_VARIABLE, trafficLightId, TL_CURRENT_PHASE, RESPONSE_GET_TL_VARIABLE);
}

std::string TraCICommandInterfaceScs::Trafficlight::getCurrentProgramID() const
{
    return traci->genericGetString(CMD_GET_TL_VARIABLE, trafficLightId, TL_CURRENT_PROGRAM, RESPONSE_GET_TL_VARIABLE);
}

TraCITrafficLightProgram TraCICommandInterfaceScs::Trafficlight::getProgramDefinition() const
{
    uint8_t resultTypeId = TYPE_COMPOUND;
...
simtime_t TraCICommandInterfaceScs::Trafficlight::getAssumedNextSwitchTime() const
{
    return traci->genericGetTime(CMD_GET_TL_VARIABLE, trafficLightId, TL_NEXT_SWITCH, RESPONSE_GET_TL_VARIABLE);
}

void TraCICommandInterfaceScs::Trafficlight::setState(std::string state)
{
...
void TraCICommandInterfaceScs::Trafficlight::setPhaseDuration(simtime_t duration)
{
...
void TraCICommandInterfaceScs::Trafficlight::setProgramDefinition(TraCITrafficLightProgram::Logic logic, int32_t logicNr)
{
...
void TraCICommandInterfaceScs::Trafficlight::setProgram(std::string program)
{
...
void TraCICommandInterfaceScs::Trafficlight::setPhaseIndex(int32_t index)
{
...
void TraCICommandInterfaceScs::addPolygon(std::string polyId, std::string polyType, const TraCIColor& color, bool filled, int32_t layer, const std::list<Coord>& points)
{
    TraCIBuffer p;
...
void TraCICommandInterfaceScs::Polygon::remove(int32_t layer)
{
    TraCIBuffer p;
...
std::list<std::string> TraCICommandInterfaceScs::getPoiIds()
{
    return genericGetStringList(CMD_GET_POI_VARIABLE, "", ID_LIST, RESPONSE_GET_POI_VARIABLE);
}

void TraCICommandInterfaceScs::addPoi(std::string poiId, std::string poiType, const TraCIColor& color, int32_t layer, const Coord& pos_)
{
    TraCIBuffer p;
...
Coord TraCICommandInterfaceScs::Poi::getPosition()
{
    return traci->genericGetCoord(CMD_GET_POI_VARIABLE, poiId, VAR_POSITION, RESPONSE_GET_POI_VARIABLE);
}

void TraCICommandInterfaceScs::Poi::remove(int32_t layer)
{
    TraCIBuffer p;
...
std::list<std::string> TraCICommandInterfaceScs::getLaneAreaDetectorIds()
{
    return genericGetStringList(CMD_GET_LANEAREA_VARIABLE, "", ID_LIST, RESPONSE_GET_LANEAREA_VARIABLE);
}

int TraCICommandInterfaceScs::LaneAreaDetector::getLastStepVehicleNumber()
{
...
std::list<std::string> TraCICommandInterfaceScs::getJunctionIds()
{
    return genericGetStringList(CMD_GET_JUNCTION_VARIABLE, "", ID_LIST, RESPONSE_GET_JUNCTION_VARIABLE);
}

Coord TraCICommandInterfaceScs::Junction::getPosition()
{
    return traci->genericGetCoord(CMD_GET_JUNCTION_VARIABLE, junctionId, VAR_POSITION, RESPONSE_GET_JUNCTION_VARIABLE);
}

std::list<Coord> TraCICommandInterfaceScs::Junction::getShape()
{
    return traci->genericGetCoordList(CMD_GET_JUNCTION_VARIABLE, junctionId, VAR_SHAPE, RESPONSE_GET_JUNCTION_VARIABLE);
}

bool TraCICommandInterfaceScs::addVehicle(std::string vehicleId, std::string vehicleTypeId, std::string routeId, simtime_t emitTime_st, double emitPosition, double emitSpeed, int8_t emitLane)
{
    TraCIConnection::Result result;
...
bool TraCICommandInterfaceScs::Vehicle::changeVehicleRoute(const std::list<std::string>& edges)
{
...
void TraCICommandInterfaceScs::Vehicle::setParameter(const std::string& parameter, int value)
{
...
void TraCICommandInterfaceScs::Vehicle::setParameter(const std::string& parameter, double value)
{
    std::stringstream strValue;
    strValue << value;
    setParameter(parameter, strValue.str());
...
void TraCICommandInterfaceScs::Vehicle::setParameter(const std::string& parameter, const std::string& value)
{
...
void TraCICommandInterfaceScs::Vehicle::getParameter(const std::string& parameter, int& value)
{
    std::string v;
...
void TraCICommandInterfaceScs::Vehicle::getParameter(const std::string& parameter, double& value)
{
    std::string v;
    getParameter(parameter, v);
    ParBuffer buf(v);
...
void TraCICommandInterfaceScs::Vehicle::getParameter(const std::string& parameter, std::string& value)
{
...
std::pair<double, double> TraCICommandInterfaceScs::getLonLat(const Coord& coord)
{
    TraCIBuffer request;
#if (VEINS_VERSION_MAJOR == 5)
...
std::tuple<std::string, double, uint8_t> TraCICommandInterfaceScs::getRoadMapPos(const Coord& coord)
{
    TraCIBuffer request;
#if (VEINS_VERSION_MAJOR == 5)
...
std::list<std::string> TraCICommandInterfaceScs::getGuiViewIds()
{
...
std::string TraCICommandInterfaceScs::GuiView::getScheme()
{
...
void TraCICommandInterfaceScs::GuiView::setScheme(std::string name)
{
    if (traci->ignoreGuiCommands) {
        EV_DEBUG << "Ignoring TraCI GUI command (as instructed by ignoreGuiCommands)" << std::endl;
        return;
...
double TraCICommandInterfaceScs::GuiView::getZoom()
{
    if (traci->ignoreGuiCommands) {
        EV_DEBUG << "Ignoring TraCI GUI command (as instructed by ignoreGuiCommands)" << std::endl;
        return 0;
...
void TraCICommandInterfaceScs::GuiView::setZoom(double zoom)
{
    if (traci->ignoreGuiCommands) {
        EV_DEBUG << "Ignoring TraCI GUI command (as instructed by ignoreGuiCommands)" << std::endl;
        return;
...
void TraCICommandInterfaceScs::GuiView::setBoundary(Coord p1_, Coord p2_)
{
    if (traci->ignoreGuiCommands) {
        EV_DEBUG << "Ignoring TraCI GUI command (as instructed by ignoreGuiCommands)" << std::endl;
        return;
...
void TraCICommandInterfaceScs::GuiView::takeScreenshot(std::string filename, int32_t width, int32_t height)
{
    if (traci->ignoreGuiCommands) {
        EV_DEBUG << "Ignoring TraCI GUI command (as instructed by ignoreGuiCommands)" << std::endl;
        return;
...
void TraCICommandInterfaceScs::GuiView::trackVehicle(std::string vehicleId)
{
    if (traci->ignoreGuiCommands) {
        EV_DEBUG << "Ignoring TraCI GUI command (as instructed by ignoreGuiCommands)" << std::endl;
        return;
...
std::string TraCICommandInterfaceScs::genericGetString(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, TraCIConnection::Result* result)
{
...
Coord TraCICommandInterfaceScs::genericGetCoord(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, TraCIConnection::Result* result)
{
...
double TraCICommandInterfaceScs::genericGetDouble(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, TraCIConnection::Result* result)
{
...
void TraCICommandInterfaceScs::genericSetDouble(uint8_t commandId, std::string objectId, uint8_t variableId, double value)
{
    uint8_t variableType = TYPE_DOUBLE;
...
simtime_t TraCICommandInterfaceScs::genericGetTime(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, TraCIConnection::Result* result)
{
...
uint8_t TraCICommandInterfaceScs::genericGetUnsignedByte(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, TraCIConnection::Result* result)
{
...
int32_t TraCICommandInterfaceScs::genericGetInt(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, TraCIConnection::Result* result)
{
...
std::list<std::string> TraCICommandInterfaceScs::genericGetStringList(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, TraCIConnection::Result* result)
{
...
std::list<Coord> TraCICommandInterfaceScs::genericGetCoordList(uint8_t commandId, std::string objectId, uint8_t variableId, uint8_t responseId, TraCIConnection::Result* result)
{
...
std::string TraCICommandInterfaceScs::Vehicle::getVType()
{
    return traci->genericGetString(CMD_GET_VEHICLE_VARIABLE, nodeId, VAR_TYPE, RESPONSE_GET_VEHICLE_VARIABLE);
}

void TraCICommandInterfaceScs::setOrder(uint32_t order)
{
    EV_INFO << "SetSUMO order ..." << endl;
