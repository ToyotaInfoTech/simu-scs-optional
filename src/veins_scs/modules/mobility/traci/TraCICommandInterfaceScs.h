...
// The original code can be found at `veins/modules/mobility/traci/TraCICommandInterface.h` of Veins-5.2. 
#pragma once
...
class VEINS_API TraCICommandInterfaceScs : public HasLogProxy {
public:
    TraCICommandInterfaceScs(cComponent* owner, TraCIConnection& c, bool ignoreGuiCommands);
    ...
    public:
        Vehicle(TraCICommandInterfaceScs* traci, std::string nodeId)
            : traci(traci)
            , nodeId(nodeId)
        {
    ...
    protected:
        TraCICommandInterfaceScs* traci;
    ...
    public:
        Road(TraCICommandInterfaceScs* traci, std::string roadId)
            : traci(traci)
            , roadId(roadId)
        {
            connection = &traci->connection;
    ...
    public:
        Lane(TraCICommandInterfaceScs* traci, std::string laneId)
            : traci(traci)
            , laneId(laneId)
        {
            connection = &traci->connection;
    ...
    public:
        Trafficlight(TraCICommandInterfaceScs* traci, std::string trafficLightId)
            : traci(traci)
    ...
    public:
        LaneAreaDetector(TraCICommandInterfaceScs* traci, std::string laneAreaDetectorId)
            : traci(traci)
    ...
    public:
        Polygon(TraCICommandInterfaceScs* traci, std::string polyId)
            : traci(traci)
            , polyId(polyId)
        {
            connection = &traci->connection;
    ...
    class VEINS_API Poi {
    public:
        Poi(TraCICommandInterfaceScs* traci, std::string poiId)
            : traci(traci)
            , poiId(poiId)
        {
            connection = &traci->connection;
    ...
    public:
        Junction(TraCICommandInterfaceScs* traci, std::string junctionId)
            : traci(traci)
    ...
    public:
        Route(TraCICommandInterfaceScs* traci, std::string routeId)
            : traci(traci)
            , routeId(routeId)
        {
            connection = &traci->connection;
    ...
    public:
        GuiView(TraCICommandInterfaceScs* traci, std::string viewId)
