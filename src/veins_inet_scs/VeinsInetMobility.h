...
// The original code can be found at `veins_inet/src/VeinsInetMobility.h` of Veins-5.2.
...
//
// change friend class from MobilityBase to LUTMotionMobility  2/20/2022
//
//class veins_sim5g_API VeinsInetMobility : public LUTMotionMobility {
class veins_sim5g_API VeinsInetMobility : public inet::MobilityBase {
public:
    VeinsInetMobility();
    ...
    virtual TraCIScenarioNetManager* getManager() const;
    virtual TraCICommandInterfaceScs* getCommandInterface() const;
    virtual TraCICommandInterfaceScs::Vehicle* getVehicleCommandInterface() const;
...
protected:
    ...
    mutable TraCIScenarioNetManager* manager = nullptr; /**< cached value */
    mutable TraCICommandInterfaceScs* commandInterface = nullptr; /**< cached value */
    mutable TraCICommandInterfaceScs::Vehicle* vehicleCommandInterface = nullptr; /**< cached value */
...
namespace veins {
class veins_sim5g_API VeinsInetMobilityAccess {
public:
