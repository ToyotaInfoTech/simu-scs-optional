...
// The original code can be found at `veins_inet/src/VeinsInetManagerForker.cc` of Veins-5.2. 

#include "VeinsInetManagerForker.h"
...
{
    TraCIScenarioNetManagerForker::initialize(stage);
