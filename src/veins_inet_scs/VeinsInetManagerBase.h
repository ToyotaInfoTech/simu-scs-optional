...
// The original code can be found at `veins_inet/src/VeinsInetManagerBase.h` of Veins-5.2.
 ...
 *
 */
class veins_sim5g_API VeinsInetManagerBase : virtual public TraCIScenarioNetManager {
public:
...
class veins_sim5g_API VeinsInetManagerBaseAccess {
public:
